...
var alert = function alert(type, message) {
  var alert = document.querySelector(".alert");
  alert.style.display = "flex";
  alert.classList.add("alert--".concat(type));
  document.querySelector(".alert-msg").innerHTML = message;
  setTimeout(function () {
    alert.style.display = "none";
    alert.classList.remove("alert--".concat(type));
  }, 3000);
};
...
var signupBtn = document.querySelector(".signup-btn"); // Signup:

var signup = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(e) {
    var name, email, password, data, res;
        ...
        switch (_context.prev = _context.next) {
          ...
          case 10:
            ...
            if (res.data.status === "success") {
              (0, _alert.alert)("success", "Signed up successfully");
              setTimeout(function () {
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 9:
            ...
            if (res.data.status === "success") {
              (0, _alert.alert)("success", "Logged in successfully");
              setTimeout(function () {
                document.location.href = "/";
              }, 1500);
            }
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          ...
          case 4:
            ...
            if (res.data.status === "success") {
              (0, _alert.alert)("success", "Logged out successfully");
              setTimeout(function () {
          ...
          case 8:
            ...
            (0, _alert.alert)("error", "Error logging out! Please Try again.");
...
var changePassword = /*#__PURE__*/function () {
  var _ref4 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4(e) {
    var curPassword, newPassword, confPassword, data, res;
    return _regeneratorRuntime().wrap(function _callee4$(_context4) {
      while (1) {
        switch (_context4.prev = _context4.next) {
          case 0:
            e.preventDefault();
            curPassword = document.querySelector(".cur-pass").value;
            newPassword = document.querySelector(".new-pass").value;
            confPassword = document.querySelector(".conf-pass").value;
            ...
            return _context4.abrupt("return", (0, _alert.alert)("error", "Passwords do not match"));
          ...
          case 10:
            ...
            if (res.data.status === "success") {
              (0, _alert.alert)("success", "Your password has been updated successfully");
              setTimeout(function () {
...
exports.updateProfile = exports.changeAvatar = void 0;
...
var randAvatar = function randAvatar() {
  var r = (Math.random() + 1).toString(36).substring(7);
  return "https://robohash.org/".concat(r);
};
...
var updateProfile = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(e) {
    var name, avatar, data, res;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            e.preventDefault();
            name = document.querySelector(".profile-edit-name").value;
          ...
          case 8:
            ...
            if (res.data.status === "success") {
              (0, _alert.alert)("success", "Profile updated successfully");
              setTimeout(function () {
                location.reload(true);
              }, 1500);
            }
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            name = document.querySelector(".lab-name").value;
            semester = document.querySelector(".lab-semester").value;
            data = {
              name: name,
              semester: semester
            };
          ...
          case 9:
            ...
            if (res.data.status === "success") {
              (0, _alert.alert)("success", "Lab Created Successfully");
...
var socket = io();
var viewCount = document.querySelector(".view-count .count"); // Viewer count:
...
if (signupForm) {
  signupForm.addEventListener("submit", _auth.signup);
} // Login:
...
if (loginForm) {
  loginForm.addEventListener("submit", _auth.login);
} // Logout:
...
if (logoutBtn) {
  logoutBtn.forEach(function (e) {
    return e.addEventListener("click", _auth.logout);
  });
} // Profile:
// Change Avatar:


var changeAvatarBtn = document.querySelector(".btn-rand-avatar");

if (changeAvatarBtn) {
  changeAvatarBtn.addEventListener("click", _profile.changeAvatar);
} // Update Profile:
...
if (updateProfileForm) {
  updateProfileForm.addEventListener("submit", _profile.updateProfile);
} // Change Password:
...
if (changePasswordForm) {
  changePasswordForm.addEventListener("submit", _auth.changePassword);
} // Delete Account:


var deleteAccountForm = document.querySelector(".delete-profile-form ");

if (deleteAccountForm) {
  deleteAccountForm.addEventListener("submit", _auth.deleteAccount);
} // Admin:
// Create Lab:


var createLabForm = document.querySelector(".createLab-form");
...
var mobMenuItems = document.querySelectorAll(".mob-menu li");
...
if (mobMenuItems) {
  mobMenuItems.forEach(function (e) {
    return e.addEventListener("click", closeMobMenu);
  });
}
